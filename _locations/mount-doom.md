---
title: "Mount Doom"
excerpt: "Orodruin, the volcano where the One Ring was forged and the only fire in which it can be unmade."
tags:
  - mordor
---

*Orodruin; Amon Amarth* · Second Age to Third Age
...
- **Type/Category:** Volcano / sacred-industrial site of the Enemy
- **Origins/Creation:** A mountain of Mordor used by Sauron in the Second Age for the One Ring; it wakes when he is active.
- **Key Affiliations/Associations:** Sauron; the One Ring; Frodo; Gollum; the Last Alliance on its slopes in the Second Age.
- **Primary Role/Purpose:** To be the forge and the sole means of the Ring’s destruction.
