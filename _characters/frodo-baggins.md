---
title: "Frodo Baggins"
excerpt: "A hobbit of the Shire who inherits the One Ring and bears it to Mordor, where it is destroyed at the cost of wounds that do not fully heal in Middle-earth."
tags:
  - hobbit
  - fellowship
  - ring-bearer
...
- **Type/Category:** Character (Hobbit)
- **Origins/Creation:** Born in the Shire in T.A. 2968; orphaned young and adopted by Bilbo Baggins of Bag End.
- **Key Affiliations/Associations:** The Shire; Bilbo; Samwise Gamgee; the Fellowship of the Ring; Gandalf; Gollum; the One Ring.
- **Primary Role/Purpose:** To remove the Ring from the Shire and convey it to the only fire in which it can be destroyed.
